...
#
# Generated by export_simulation on Mon Oct 24 20:22:21 -0400 2016
#
################################################################################
...
switch to the './SD_Out_FIFO.sh' script.

./SD_Out_FIFO.sh -reset_run
...
./SD_Out_FIFO.sh -noclean_files

For more information on the script, please type './SD_Out_FIFO.sh -help'.
