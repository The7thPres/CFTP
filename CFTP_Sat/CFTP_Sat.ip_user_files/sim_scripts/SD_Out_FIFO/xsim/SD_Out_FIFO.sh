...
#
# Generated by Vivado on Mon Oct 24 20:22:21 -0400 2016
# IP Build 1681267 on Mon Oct 10 21:28:31 MDT 2016 
#
# usage: SD_Out_FIFO.sh [-help]
# usage: SD_Out_FIFO.sh [-lib_map_path]
# usage: SD_Out_FIFO.sh [-noclean_files]
# usage: SD_Out_FIFO.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "SD_Out_FIFO.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SD_Out_FIFO xil_defaultlib.SD_Out_FIFO xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim SD_Out_FIFO -key {Behavioral:sim_1:Functional:SD_Out_FIFO} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./SD_Out_FIFO.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SD_Out_FIFO.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./SD_Out_FIFO.sh -help\" for more information)\n"
    exit 1
  fi
