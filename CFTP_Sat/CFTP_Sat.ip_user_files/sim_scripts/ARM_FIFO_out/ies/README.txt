...
#
# Generated by export_simulation on Mon Oct 24 20:27:04 -0400 2016
#
################################################################################
...
switch to the './ARM_FIFO_out.sh' script.

./ARM_FIFO_out.sh -reset_run
...
./ARM_FIFO_out.sh -noclean_files

For more information on the script, please type './ARM_FIFO_out.sh -help'.
