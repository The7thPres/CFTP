...
#
# Generated by export_simulation on Mon Oct 24 20:24:59 -0400 2016
#
################################################################################
...
switch to the './ARM_FIFO_in.sh' script.

./ARM_FIFO_in.sh -reset_run
...
./ARM_FIFO_in.sh -noclean_files

For more information on the script, please type './ARM_FIFO_in.sh -help'.
