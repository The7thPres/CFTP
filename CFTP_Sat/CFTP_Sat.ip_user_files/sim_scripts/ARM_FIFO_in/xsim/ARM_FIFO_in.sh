...
#
# Generated by Vivado on Mon Oct 24 20:24:59 -0400 2016
# IP Build 1681267 on Mon Oct 10 21:28:31 MDT 2016 
#
# usage: ARM_FIFO_in.sh [-help]
# usage: ARM_FIFO_in.sh [-lib_map_path]
# usage: ARM_FIFO_in.sh [-noclean_files]
# usage: ARM_FIFO_in.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "ARM_FIFO_in.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ARM_FIFO_in xil_defaultlib.ARM_FIFO_in xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ARM_FIFO_in -key {Behavioral:sim_1:Functional:ARM_FIFO_in} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./ARM_FIFO_in.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ARM_FIFO_in.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./ARM_FIFO_in.sh -help\" for more information)\n"
    exit 1
  fi
